...
const langArr = {
  ...
  aboutMeUndertitle: {
    en: 'Hello! My name is Oleh, and I’m 34 years old, proudly hailing from the beautiful city of Lviv, Ukraine. I like to think of myself as punctual and responsible, always eager to learn and grow in my field. When I’m not coding, you can usually find me exploring new places, or enjoying a good movie (yes, I’m a film buff!) Check out my website >>> <a title="Create your own movie collection" class="link" href="https://collection-films.org.ua/" target="_blank" rel="noopener noreferrer">Collection films</a>. I get inspired by working in a team where creativity, knowledge sharing, and support are valued. I enjoy contributing to processes that help create something truly interesting and useful.',
    es: 'Mi nombre es Oleh, tengo 34 años y soy orgullosamente de la hermosa ciudad de Lviv, Ucrania. Me considero una persona puntual y responsable, siempre con ganas de aprender y crecer en mi campo. Cuando no estoy programando o diseñando, generalmente me encontrarás explorando nuevos lugares o disfrutando de una buena película (sí, soy un cinéfilo) Echa un vistazo a mi sitio web >>> <a title="Crea tu propia colección de películas" class="link" href="https://collection-films.org.ua/" target="_blank" rel="noopener noreferrer">Collection films</a>. Me inspiro trabajando en un equipo donde se valoran la creatividad, el intercambio de conocimientos y el apoyo. Disfruto participar en procesos que ayudan a crear algo realmente interesante y útil.',
    ua: 'Мене звати Олег, мені 34 роки, і я з прекрасного міста Львів, Україна. Вважаю себе пунктуальною та відповідальною людиною, яка завжди прагне вчитися і розвиватися у своїй сфері. Коли я не займаюся кодингом, мене можна знайти в подорожах новими місцями або за переглядом хорошого фільму (так, я кіноман!) Зацініть мій сайт >>> <a title="Створіть свою колекцію фільмів" class="link" href="https://collection-films.org.ua/" target="_blank" rel="noopener noreferrer">Collection films</a>. Я отримую натхнення від роботи в команді, де цінуються креативність, обмін досвідом і підтримка. Мені подобається долучатися до процесів, які допомагають створювати щось справді цікаве й корисне.',
  },
  skillsTitle: {
    en: "Skills",
    es: "Habilidades",
