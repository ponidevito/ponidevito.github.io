...
const langArr = {
  ...
  aboutMeUndertitle: {
    ...
    es: "Mi nombre es Oleh, tengo 34 años y soy orgullosamente de la hermosa ciudad de Lviv, Ucrania. Me considero una persona puntual y responsable, siempre con ganas de aprender y crecer en mi campo. Cuando no estoy programando, generalmente me encontrarás explorando nuevos lugares o disfrutando de una buena película (sí, soy un cinéfilo). Me emociona formar parte de un equipo que valore la creatividad y la innovación, y estoy listo para afrontar nuevos desafíos mientras aporto un toque de humor y entusiasmo a todo lo que hago. ¡Hagamos grandes cosas juntos!",
    ua: "Мене звати Олег, мені 34 роки, і я з прекрасного міста Львів, Україна. Вважаю себе пунктуальною та відповідальною людиною, яка завжди прагне вчитися і розвиватися у своїй сфері. Коли я не займаюся кодингом, мене можна знайти в подорожах новими місцями або за переглядом хорошого фільму (так, я кіноман!). Мене надихає можливість приєднатися до команди, що цінує креативність та інновації, і я готовий приймати нові виклики, додаючи трохи гумору та ентузіазму в усе, що роблю. Давайте творити круті речі разом!",
  },
  skillsTitle: {
    en: "Skills",
    es: "Habilidades",
